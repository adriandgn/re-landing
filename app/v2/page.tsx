  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative bg-primary text-primary-foreground px-6 py-24 md:py-32 overflow-hidden">
        ...
        />
        <img className="absolute inset-0 re-iso h-200" src="/SVG/iso.svg" alt="" />
        ...
        <div className="relative max-w-4xl mx-auto z-10">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight color-secondary text-balance">
                Re: is a playground for wardrobe reinvention.
              </h1>
      ...
      <section className="relative px-6 py-24 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('/sustainable-fashion-upcycling-workshop-with-sewing.png')",
          }}
        />
        <div className="relative max-w-6xl mx-auto z-10">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">B2C KEY BENEFITS</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className={`${benefit.bg} ${benefit.bg === "bg-primary" ? "text-primary-foreground" : "text-accent-foreground"} border-4 border-foreground shadow-[8px_8px_0px_0px] shadow-foreground ${benefit.bg.includes("col-span") ? benefit.bg.split(" ").slice(1).join(" ") : ""}`}
              >
                <CardHeader>
                ...
                <CardContent>
                  <CardDescription
                    className={`${benefit.bg === "bg-primary" ? "text-primary-foreground/80" : "text-accent-foreground/80"} text-base`}
                  >
                    {benefit.description}
                  </CardDescription>
                </CardContent>
        ...
        <div className="relative max-w-4xl mx-auto z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-4 border-foreground shadow-[8px_8px_0px_0px] shadow-foreground">
              <CardHeader>
                <div className="w-12 h-12 bg-accent text-accent-foreground rounded-none border-2 border-foreground flex items-center justify-center font-bold text-xl mb-4">
                  01
                </div>
            ...
            <Card className="border-4 border-foreground shadow-[8px_8px_0px_0px] shadow-foreground">
              <CardHeader>
                <div className="w-12 h-12 bg-primary text-primary-foreground rounded-none border-2 border-foreground flex items-center justify-center font-bold text-xl mb-4">
                  02
                </div>
